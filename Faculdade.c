...
void imprimeFaculdadeTexto(Faculdade faculdade, FILE *arq)
{
    fprintf(arq, "\nFaculdade: %s\n", faculdade.nome);
    fprintf(arq, "Data de ingresso: %d/%d/%d", faculdade.dataIngresso.dia,
    faculdade.dataIngresso.mes, faculdade.dataIngresso.ano);
    imprimeCursoTexto(faculdade.curso, arq);
}
